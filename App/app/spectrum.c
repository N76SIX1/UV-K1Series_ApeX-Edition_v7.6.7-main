...
static void DrawTriggerMarker(uint8_t x0, uint8_t y, bool pointRight)
{
    y = clamp(y, DrawingTopY + 1, DrawingEndY - 4);

    if (pointRight)
    {
        PutPixel(x0 + 0, y,     true);
        PutPixel(x0 + 0, y + 1, true);
        PutPixel(x0 + 1, y + 1, true);
        PutPixel(x0 + 0, y + 2, true);
        PutPixel(x0 + 1, y + 2, true);
        PutPixel(x0 + 2, y + 2, true);
        PutPixel(x0 + 0, y + 3, true);
        PutPixel(x0 + 1, y + 3, true);
        PutPixel(x0 + 0, y + 4, true);
    }
    else
    {
        PutPixel(x0 + 2, y,     true);
        PutPixel(x0 + 1, y + 1, true);
        PutPixel(x0 + 2, y + 1, true);
        PutPixel(x0 + 0, y + 2, true);
        PutPixel(x0 + 1, y + 2, true);
        PutPixel(x0 + 2, y + 2, true);
        PutPixel(x0 + 1, y + 3, true);
        PutPixel(x0 + 2, y + 3, true);
        PutPixel(x0 + 2, y + 4, true);
    }
}
...
static void DrawRssiTriggerLevel(const uint8_t *topY)
{
    ...
    DrawTriggerMarker(0,   y, true);
    DrawTriggerMarker(125, y, false);
}
...
static void UpdateListening()
{
    ...
    {
#ifndef ENABLE_FEAT_N7SIX_SPECTRUM
