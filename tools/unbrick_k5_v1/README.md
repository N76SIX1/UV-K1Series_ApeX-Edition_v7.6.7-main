...
Restoring a UV-K5 V1 accidentally flashed with the N7SIX Fusion 🔥 Edition firmware, using OpenOCD and a ST-LINK programmer.

## Introduction

Some users have accidentally flashed a UV-K5 V1 with the N7SIX Fusion 🔥 Edition firmware. This edition **is only** compatible with:
